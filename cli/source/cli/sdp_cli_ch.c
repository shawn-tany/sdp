...
static int cli_ch_single_register(SDP_CLI_CHSET_T *cli_ch_set,
...
static int cli_ch_multi_input(SDP_CLI_CHSET_T *cli_ch_set, char ch)
{
    PTR_CHECK_N1(cli_ch_set);
...
static int cli_ch_single_input(SDP_CLI_CHSET_T *cli_ch_set, char ch)
{
    PTR_CHECK_N1(cli_ch_set);
...
int cli_ch_init(SDP_CLI_CHSET_T *cli_ch_set)
{
    ...
    /* tab */
    cli_ch.ch = 0x09; 
    cli_ch_single_register(cli_ch_set, SDP_CLI_CH_SINGLE_COMPLECTION, cli_ch);

    /* enter */  
    cli_ch.ch = 0x0a;
    cli_ch_single_register(cli_ch_set, SDP_CLI_CH_SINGLE_EXECUTE, cli_ch);

    /* ? */ 
    cli_ch.ch = 0x3f;    
    cli_ch_single_register(cli_ch_set, SDP_CLI_CH_SINGLE_HELP, cli_ch);

    /* whitespace */
    cli_ch.ch = 0x20; 
    cli_ch_single_register(cli_ch_set, SDP_CLI_CH_SINGLE_SEPARATE, cli_ch);

    /* backspace */
    cli_ch.ch = 0x08; 
    cli_ch_single_register(cli_ch_set, SDP_CLI_CH_SINGLE_BACKSPACE, cli_ch);
